...
/*******************
Rotaion: 0-0 degree direction
Rotaion: 90-90 degree direction
Rotaion: 180-180 degree direction
Rotaion: 270-270 degree direction
*******************/
#define Rotation 180  


void Paint_NewImage(uint8_t *image,uint16_t Width,uint16_t Height,uint16_t Rotate,uint16_t Color); 					 //Create canvas to control display orientation
