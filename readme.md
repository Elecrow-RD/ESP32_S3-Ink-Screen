...
Use the Image2Lcd 2.9 for converting a bitmap to binary file and adjust the header in the image file. See working samples.
line 1 of Pic.h needs to be like this:
